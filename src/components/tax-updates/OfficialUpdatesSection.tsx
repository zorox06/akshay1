...
const taxUpdates = [
  {
    id: 1,
    title: "New Budget 2024-25 Tax Implications",
    date: "February 1, 2024",
    description: "The Union Budget 2024-25 introduces significant changes to income tax rates and slabs under the new tax regime.",
    category: "Budget",
    content: "The Finance Minister announced in the Union Budget 2024-25 that the new tax regime will now be the default option. Income tax rebate limit increased from ₹5 lakh to ₹7 lakh under the new tax regime. Standard deduction of ₹50,000 has been introduced in the new tax regime. The number of tax slabs reduced from 6 to 5, with significant increase in tax exemption limits."
  },
  {
    id: 2,
    title: "Updated GST Filing Dates for 2024",
  ...
  {
    id: 3,
    title: "Changes in TDS Rates for FY 2024-25",
    date: "April 1, 2024",
    description: "The government has revised TDS rates for various income sources effective April 1, 2024.",
    category: "TDS",
  ...
  },
  {
    ...
    date: "March 15, 2024",
    description: "CBDT extends the due date for filing tax audit reports for AY 2024-25.",
    category: "Compliance",
    content: "The Central Board of Direct Taxes (CBDT) has extended the due date for filing tax audit reports under various sections of the Income Tax Act for Assessment Year 2024-25 from September 30, 2024, to October 15, 2024. This extension applies to tax audit reports under Section 44AB, 92E, and other relevant sections."
  },
  {
    id: 5,
